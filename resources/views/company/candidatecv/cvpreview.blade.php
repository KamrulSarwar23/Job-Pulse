...
<div class="resume">
    ...
    <div class="base">
        <div class="profile">
            <div class="photo">
                <button class="printinvoice"><i class="fas fa-print"></i>
                    Print</button>
                <!--<img src="" /> -->
            ...
            <div class="col-md-6">
                <div class="image">
                    <img width="150px" height="180px" src="{{ asset(@$candidateBasicInformation->image) }}"
                        alt="">
                </div>
            </div>
        ...
        <div class="contact">
            <h3>Contact Me</h3>
            <div class="call"><a href="tel:123-456-7890"><i class="fas fa-phone"></i><span>Phone:
                        {{ @$candidateBasicInformation->phone }}</span></a></div>
            <div class="address"><a href="#"><i
                        class="fas fa-map-marker"></i><span>{{ @$candidateBasicInformation->email }}</span></a>
            </div>
            <div class="email"><a href="{{ @$candidateBasicInformation->github_link }}" target="_blank"><i
                        class="fas fa-envelope"></i><span>{{ @$candidateBasicInformation->github_link }}</span></a>
            </div>
            <div class="website"><a href="{{ @$candidateBasicInformation->portfolio_website }}" target="_blank"> <i
                        class="fas fa-home"></i><span>{{ @$candidateBasicInformation->portfolio_website }}</span></a>
            </div>
        </div>
        ...
        <div class="work">
            ...
            <ul>
                @foreach (@$candidateJobExperience as $item)
                    @if (@$item->designation)
                        <li><span>{{ @$item->designation }}<br>{{ @$item->company_name }}</span><small>{{ @$item->joining_date }}
                                to {{ @$item->depareture_date }}</small></li>
                    @endif
                @endforeach
        ...
        <div class="edu">
            ...
            <ul>
                ...
                @foreach (@$candidateDegree as $item)
                    @if (@$item->degree_type)
                        <li><span>{{ @$item->degree_type }}<br>{{ @$item->university_name }}</span><small>{{ @$item->department }}</small><small>{{ @$item->passing_year }}</small>
                        </li>
                    @endif
                @endforeach
            ...
            <ul>
                ...
                @foreach (@$candidateTraining as $item)
                    @if (@$item->training_name)
                        <li><span>{{ @$item->training_name }}<br>{{ @$item->institution_name }}</span><small>{{ @$item->completion_year }}</small>
                        </li>
                    @endif
                @endforeach
